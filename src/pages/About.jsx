  ...
  return (
    <div className="section-padding container">
      ...
      <div style={{ maxWidth: '850px', margin: '0 auto', background: 'var(--bg-card)', border: 'var(--border-subtle)', borderRadius: '16px', padding: '3.5rem' }}>
        <h2 style={{ fontSize: '2rem', marginBottom: '1rem', color: '#FFFFFF' }}>WHO ARE WE?</h2>
        ...
        <h2 style={{ fontSize: '2rem', marginBottom: '1rem', color: '#FFFFFF' }}>THE MISSION</h2>
        <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', lineHeight: '1.7', marginBottom: '2.5rem' }}>
        ...
        <h2 style={{ fontSize: '2rem', marginBottom: '1rem', color: '#FFFFFF' }}>WHY "WHT"?</h2>
